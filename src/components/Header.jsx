...
export default function Header({ setIsOpen, activeItem }) {
  return (
    <header className=" backdrop-blur-xl sticky top-0 left-0 rounded-2xl px-4 md:px-8 flex items-center justify-between h-16  md:h-20 shadow-lg   z-40">
      <div className="flex items-center justify-between w-full space-x-4">
        <div className="min-w-0 flex-1">
          <h1 className="text-2xl md:text-3xl font-bold text-primary tracking-tight truncate">
